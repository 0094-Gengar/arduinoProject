...
//    }
//
//    // 클라이언트 연결 후 "Hi Client!" 메시지를 보내기 위한 메소드
//    @MessageMapping("/connect")
//    public void sendHelloMessage() {
//        messagingTemplate.convertAndSend("/topic/zoneStatus", "Hi Client!");
//    }
//
...
//        messagingTemplate.convertAndSend("/topic/zoneStatus", statusMessage);  // "/topic/zoneStatus" 경로로 메시지 전송
//    }
//
